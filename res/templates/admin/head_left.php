		...
		<div class="card reset-margin">
			<div class="card-image">
				...
				<span class="card-title" style="padding: 20px; "><i  id="user-name"><?=$info['name']?></i>
					<a href="../admin/dashboard.php" class="cursor blue-text text-darken-2"><i class="material-icons">create</i></a>
				</span>
			</div>
		</div>
			...
			<li class="">
				<div class="collapsible-header" id="menu"><i class="material-icons hide" id="menu-arrow-down">arrow_drop_down</i>
					...
					<div class="collapsible-body list">
						<a href="resource/res/templates/admin/admins_panel.php" class="menu-list cursor">Quản Lý Admin</a>
						<a href="../admin/teachers_panel.php" class="menu-list cursor">Quản Lý Gíao Viên</a>
						<a href="../admin/classes_panel.php" class="menu-list cursor">Quản Lý Lớp</a>
						<a href="../admin/students_panel.php" class="menu-list cursor">Quản Lý Học Sinh</a>
						<a href="../admin/subjects_panel.php" class="menu-list cursor">Quản Lý Môn</a>
						<a href="./questions_panel.php" class="menu-list cursor">Quản Lý Câu Hỏi</a>
						<a href="../admin/tests_panel.php" class="menu-list cursor">Quản Lý Bài Kiểm Tra</a>
					</div>
				</li>
				<a href="./notifications_panel.php" class="collapsible-header font-color"><i class="material-icons">send</i>Gửi Thông Báo</a>
				<a href="./index.html" class="collapsible-header font-color"><i class="material-icons">insert_comment</i>Liên Hệ</a>
			</ul>
		</div>
