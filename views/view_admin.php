...
class View_Admin
{
    ...
    {
        include 'res/templates/admin/admins_panel.php';
    }
    ...
    {
        include 'res/templates/admin/teachers_panel.php';
    }
    public function show_classes_panel()
    {
        include 'res/templates/admin/classes_panel.php';
    }
    public function show_students_panel()
    {
        include 'res/templates/admin/students_panel.php';
    }
    public function show_questions_panel()
    {
        include 'res/templates/admin/questions_panel.php';
    }
    public function show_add_question()
    {
        include 'res/templates/admin/add_question.php';
    }
    ...
    {
        include 'res/templates/admin/subjects_panel.php';
    }
    public function show_tests_panel()
    {
        include 'res/templates/admin/tests_panel.php';
    }
